...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Logistics Service Provider`}</title>

        <meta
          name="description"
          content="Experience seamless and efficient logistics with Logistics Service Provider - your partner for domestic and international parcel delivery, express, road, air, ocean freight and end-to-end supply chain management solutions."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1565793298595-6a879b1d9492?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb2dpc3RpY3N8ZW58MHx8fHwxNjk0NzUzMjc2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless and efficient logistics with Logistics Service Provider - your partner for domestic and international parcel delivery, express, road, air, ocean freight and end-to-end supply chain management solutions.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Supply Chain Manager"
