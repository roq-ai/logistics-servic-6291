...
export function ProviderListPage(props: ProviderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProviders({
        relations: ['user', 'order.count', 'product.count', 'service_rate.count', 'task.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('product', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('service_rate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'service_rate',
          header: 'Service Rate',
          accessorKey: 'service_rate',
          cell: ({ row: { original: record } }: any) => record?._count?.service_rate,
        }
      : null,
