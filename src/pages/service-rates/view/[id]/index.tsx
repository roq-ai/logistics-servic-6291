...
import { getServiceRateById } from 'apiSdk/service-rates';
import { ServiceRateInterface } from 'interfaces/service-rate';

function ServiceRateViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('service_rate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/service-rates/edit/${id}`} passHref legacyBehavior>
                    <Button
